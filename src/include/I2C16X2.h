...
void print_int(int i);					    // print integer
void print_float(float myFloat);            // print float
void print_string(const char *s);           // print string
void print_char(char val);				    // print a char
